...
import ListingCartItem from "../components/ListingCartItem";
  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="flex-1">
        <h1 className="text-3xl font-semibold border-b border-slate-200 p-3 text-slate-700 mt-5">
          Listing results:
        </h1>
        <div className="p-7 flex flex-wrap gap-4">
          ...
          {!loading &&
            ...
            listings.map((listing) => (
              <ListingCartItem key={listing._id} listing={listing} />
            ))}
